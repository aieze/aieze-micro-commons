...
let fromMobileNumber = process.env.AIEZE_COMMON_WHATSAPP_GATEWAY_FROM_MOBILE_NUMBER;
let whatsappApiKey = process.env.AIEZE_COMMON_WHATSAPP_GATEWAY_API_KEY;
let whatsappGatewayUrl = process.env.AIEZE_COMMON_WHATSAPP_GATEWAY_BASE_URL;
