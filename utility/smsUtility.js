...
let entityId = process.env.AIEZE_COMMON_DLT_ENTITY_ID;
let senderId = process.env.AIEZE_COMMON_DLT_SENDER_ID;
let userId = process.env.AIEZE_COMMON_SMS_GATEWAY_USER_ID;
let password = process.env.AIEZE_COMMON_SMS_GATEWAY_PASSWORD;
let smsGatewayUrl = process.env.AIEZE_COMMON_SMS_GATEWAY_BASE_URL;
