...
const user = process.env.AIEZE_COMMON_NOSQL_USER;
const database = process.env.AIEZE_COMMON_NOSQL_DATABASE;
const auth_database = process.env.AIEZE_COMMON_NOSQL_AUTH_DATABASE ? process.env.AIEZE_COMMON_NOSQL_AUTH_DATABASE : database;
const password = process.env.AIEZE_COMMON_NOSQL_PASSWORD;
const host = process.env.AIEZE_COMMON_NOSQL_HOST;
const port = process.env.AIEZE_COMMON_NOSQL_PORT;
const tls = process.env.AIEZE_COMMON_NOSQL_TLS ? process.env.AIEZE_COMMON_NOSQL_TLS : false;
const connectionRequired = process.env.AIEZE_COMMON_NOSQL_DB_REQUIRED
